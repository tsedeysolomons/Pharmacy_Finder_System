    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Medicines",
                columns: new[] { "MedicineId", "Description", "Manufacturer", "MedicineName" },
                values: new object[] { 1, null, "Generic", "Paracetamol" });

            migrationBuilder.InsertData(
                table: "Medicines",
                columns: new[] { "MedicineId", "Description", "IsPrescriptionRequired", "Manufacturer", "MedicineName" },
                values: new object[] { 2, null, true, "HealthCorp", "Amoxicillin" });

            migrationBuilder.InsertData(
                table: "Medicines",
                columns: new[] { "MedicineId", "Description", "Manufacturer", "MedicineName" },
                values: new object[] { 3, null, "MediHealth", "Ibuprofen" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@pharmacyfinder.com", "System Administrator", true, "AQAAAAIAAYagAAAAEHeQH5j8F+qwo0hHywIkMHqq7gBLq45c/2E7FJX8C0nNJgTqj6nE8nXhU6JxNcZ7UA==", "+1234567890" });
